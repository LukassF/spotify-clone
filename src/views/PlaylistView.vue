            ...
            <header>
                ...
                <div class="header-contents">
                    ...
                    <div class="playlist-stats">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Spotify_icon.svg/1982px-Spotify_icon.svg.png" alt="spotify-logo" style="width: 25px;">
                        <h5>Spotify</h5>
                        <ul>
                            <li>{{ Math.round(Math.random(1)*10000000).toLocaleString("en-US") }} likes</li>
...
import { onMounted } from 'vue';
    ...
    export default{
        ...
        mounted(){
            ...
            this.gradientBackground = 'background:linear-gradient('+ this.chosenColor +',transparent);'
        }
    }
</script>
